    ...
    <table class="table table-hover table-responsive" style="border-top:hidden;">
            ...
            <asp:Repeater ID="rptHelpTopic" runat="server" OnItemDataBound="rptHelpTopic_ItemDataBound">
                ...
                <ItemTemplate>
                    ...
                    <td><asp:Label runat="server" ID="lblRelatedTopics"></asp:Label></td>
                    <td><button id="editButton" onclick="javascript:window.location.href='../../Admin/RelatedTopics/Form.aspx?id=<%# Eval("Help_Topic_ID")  %>'; return false;">Edit</button></td>
                    </tr>
                    </ItemTemplate>
                </asp:Repeater>
